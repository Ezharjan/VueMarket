    ...
    <div id="myVip" ref="myVip">
            ...
            <div class="coupons">
                ...
                <div class="quanBox">
                    ...
                    >
                        ...
                        <div
                            class="couponsConditions"
                        >{{$t('mine.to')}}{{item.pay_min}}{{$t('mine.toUse')}}</div>
                        <div class="couponsScope">{{item.description}}</div>
                        <div class="getCopons">{{$t('mine.immeatallyGet')}}</div>
                    </div>
                </div>
                <!--本周专享券-->
        ...
        <transition name="fade">
            <div class="bottomJoinVip" v-show="isShowBottomBtn" transiton="fade">
                ...
                <div class="joinVip" @click="goToPayPage">{{$t('mine.openCards')}}</div>
            </div>
        </transition>
        <!-- 数据加载提示gif -->
