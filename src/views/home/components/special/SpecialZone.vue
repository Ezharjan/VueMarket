<template>
    <div id="specialZone">
        ...
        <div class="wrapperItem">
            <div class="newItem" v-for="newItem in specialZone.newItemList" :key="newItem.id">
            ...
            <!-- 九月热卖 -->
            <div class="hotItem" v-for="hotItem in specialZone.hotItemList" :key="hotItem.id">
            ...
            <!-- VIP专享 -->
            <div class="vipItem" v-for="vipItem in specialZone.vipItemList" :key="vipItem.id">
            ...
            >
                ...
                <img class="otherImage" src="../../../../images/special/peanut.jpeg" alt />
            </div>
